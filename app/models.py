...
class Client(db.Model):
    ...
    card_colour = db.Column(db.String(30), nullable=True)
    card_border = db.Column(db.String(30), nullable=True)
    card_font = db.Column(db.String(30), nullable=True)
...
class Order(db.Model):
    ...
    delivery_name = db.Column(db.String(255), default='')
    delivery_line1 = db.Column(db.String(255), default='')
    delivery_line2 = db.Column(db.String(255), default='')
    delivery_city = db.Column(db.String(100), default='')
    delivery_postcode = db.Column(db.String(20), default='')
    created_at = db.Column(db.DateTime, default=lambda: datetime.now(timezone.utc))
    updated_at = db.Column(db.DateTime, default=lambda: datetime.now(timezone.utc), onupdate=lambda: datetime.now(timezone.utc))
